...
const filteredRealms = computed(() => {
  ...
  return props.realms.filter(r => r.name.toLowerCase().includes(query.value.toLowerCase()))
})
      ...
      <ul class="max-h-64 overflow-y-auto">
        ...
        >
          <span class="flex items-center gap-2">
            ...
            >
              <svg v-if="modelValue.includes(realm.slug)" viewBox="0 0 12 12" class="size-2.5 text-white" fill="currentColor">
